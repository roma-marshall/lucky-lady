<template>
  <div class="flex flex-row justify-around my-10 bg-[#0e1122] py-3 rounded-lg">
    ...
    <div class="flex pb-5 lg:pb-0 mx-2">
      <input type="search" placeholder="Search games" class="bg-[#191d32] outline-none text-white px-5 py-0.5 rounded-l-lg">
